...
var script_forms = document.querySelectorAll('.form');
var phoneInputs = document.querySelectorAll('.form__input');
var cardBtn = document.querySelectorAll('.card__btn');
var popup = document.querySelector('.popup');
var $body = document.body;
var btnClosePopup = document.querySelector('.popup__btn-close');
var header = document.querySelector('.header');
var repair = document.querySelector('.repair');
var hero = document.querySelector('.hero');
var aboutBlocks = document.querySelector('.about-blocks');
var popupBtnSubmit = document.querySelector('.popup-btn-submit');
var burger = document.querySelector('.header__burger');
var mobMenuOverlay = document.querySelector('.mob-menu');
var closeBtnMenu = document.querySelector('.mob-menu__close-btn');
var mobMenuListItems = document.querySelectorAll('.mob-menu__nav-list-item');
var hedaerMenuItem = document.querySelectorAll('.header__nav-item-link');
//передаем класс и моодифицируем элементы меню
hedaerMenuItem.forEach(function (item) {
  item.addEventListener('click', function () {
    hedaerMenuItem.forEach(function (el) {
...
mobMenuListItems.forEach(function (el) {
  el.addEventListener('click', function () {
    mobMenuOverlay.classList.remove('mob-menu--open');
    $body.style.overflowY = 'visible';
  });
});
mobMenuOverlay.addEventListener('click', function (e) {
...
script_forms.forEach(function (form) {
  form.addEventListener('submit', function (e) {
    if (e.target == form) {
      var inputNode = form.querySelector('.form__input');
      if (inputNode.value.length < 18) {
        e.preventDefault();
        var result = 18 - inputNode.value.length;
...
var stickyBlock = $('.repair__desc').offset().top;
...
popupBtnSubmit.addEventListener('click', function () {
  var parent = popupBtnSubmit.closest('.form');
  var inputNode = parent.querySelector('.form__input');
  if (inputNode.value.length == 18) {
    enabledScroll();
  }
});
